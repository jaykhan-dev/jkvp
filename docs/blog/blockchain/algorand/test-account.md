...
In this short tutorial (see [official page](https://developer.algorand.org/tutorials/create-account-testnet-python/) in the Algorand docs) we will create a test account, fund it with test Algos, get the mnemonic keys, and account addresses. 
